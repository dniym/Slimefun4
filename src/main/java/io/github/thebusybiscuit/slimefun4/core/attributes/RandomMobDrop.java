 ...
 * a percentage chance to drop for an {@link SlimefunItem} on {@link EntityDeathEvent}, this 
 *  chance is 0-100 and used in conjunction with the {@link RecipeType#MOB_DROP}.
 * 
 * @author dNiym
 *
...
public interface RandomMobDrop extends ItemAttribute {
     ...
     * added to the dropList when {@link EntityType} specified in {@link RecipeType#MOB_DROP} 
